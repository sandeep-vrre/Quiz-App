package android.example.geographyquiz;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitQuiz(View view) {
        ...
        int score = calculateScore(writeAnswer_8,checkRadio_1b, checkRadio_2b, checkRadio_3c, checkRadio_4b, checkRadio_5d, checkCheckBox_6a, checkCheckBox_6b, checkCheckBox_6c, checkCheckBox_6d, checkCheckBox_6e, checkCheckBox_7a, checkCheckBox_7b, checkCheckBox_7c,checkCheckBox_7d, checkCheckBox_7e);
         ...
         */
        String scoreMessage = "Congrats, " + nameBlank + " \n You scored " + score + " out of 8! " + msg;

        // show the score as toast
    ...
    private int calculateScore(String ifWriteAnswer_8, boolean ifCheckRadio_1b, boolean ifCheckRadio_2b, boolean ifCheckRadio_3c, boolean ifCheckRadio_4b, boolean ifCheckRadio_5d, boolean ifCheckCheckBox_6a, boolean ifCheckCheckBox_6b, boolean ifCheckCheckBox_6c, boolean ifCheckCheckBox_6d, boolean ifCheckCheckBox_6e, boolean ifCheckCheckBox_7a, boolean ifCheckCheckBox_7b, boolean ifCheckCheckBox_7c, boolean ifCheckCheckBox_7d, boolean ifCheckCheckBox_7e) {
        ...
        if(ifCheckCheckBox_6d && ifCheckCheckBox_6e && !ifCheckCheckBox_6a && !ifCheckCheckBox_6b && !ifCheckCheckBox_6c)
            baseScore += 1;

        if(ifCheckCheckBox_7a && ifCheckCheckBox_7d && !ifCheckCheckBox_7b && !ifCheckCheckBox_7c && !ifCheckCheckBox_7e)
                baseScore = baseScore + 1;
